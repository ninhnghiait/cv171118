        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @php
                $id = $arItem->id;
            @endphp
            <form action="{{ route('users_admin.update', $id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
              @csrf
              @method('put')
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <select name="vgroup[]" size="4" multiple="multiple" class="form-control">
                    ...
                    @foreach ($objItemsGroup as $objGroup)
                        @if (in_array($objGroup->id_group, $arGroupOld))
