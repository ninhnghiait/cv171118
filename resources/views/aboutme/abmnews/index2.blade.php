      ...
      <div class="content-body">
        <div class="section-padd br-t " >
          ...
          <div class="container-body clearfix">
            ...
            <div class="blog-post-item">
              ...
              <div class="post-share clearfix">
                ...
                <div class="post-share-box share-comments col-sm-4">
                  <a href="#"><span>{{$countCmt}}</span> Comments</a>   
                </div>
              </div>
            ...
            <nav>
              <ul class="pager">
                <li class="next"><a href="#">Next<span class="hidden-sm hidden-xs"></span> <span aria-hidden="true">&rarr;</span></a></li>
              </ul>
            </nav><!-- end pager-->
          </div>
          @endif
